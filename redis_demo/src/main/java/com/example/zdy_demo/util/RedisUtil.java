package com.example.zdy_demo.util;
...
public final class RedisUtil {
    ...
    public long hincrL(String key, String item, long by) {
        return redisTemplate.opsForHash().increment(key, item, by);
    }
    /**
     * hash递减
...
//    public Set<String> zReverseRangeByScore(String key, double min, double max,long offset, final long count) {
//        return redisTemplate.opsForZSet().reverseRangeByScore(key, min, max);
//    }
     ...
     * @return
     */
    public Long zRemoveValue(String key, Object value) {
